...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['foto_id'])) {
    ...
    if(isset($_COOKIE['liked_'.$foto_id])) {
        ...
        setcookie('liked_'.$foto_id, '1', time() + 3600, '/'); // Set cookie untuk 1 jam
    }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg" style="background-color : #3498db;">
        <div class="container mt-2 mb-2">
            <a class="navbar-brand text-light" href="index.php"><i class="fas fa-moon" style="margin-right: 10px;"></i><strong>Galeri Foto</strong></a>
            ...
            <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
                ...
                <a href="register.php" class="btn btn-info" style="margin-right: 10px;">Register</a>
